...
%
 ...
 %
 & = \bm{\Sigma}_{\tilde{\epsilon} + \epsilon}^{ - 1} + \bm{\Sigma}_{\tilde{\epsilon} + \epsilon}^{ - 1} \bm{c}^T \left(\bm{C}^{*^{ - 1}} + \bm{c} \bm{\Sigma}_{\tilde{\epsilon} + \epsilon}^{ - 1} \bm{c}^T \right)^{ - 1} \bm{c} \bm{\Sigma}_{\tilde{\epsilon} + \epsilon}^{ - 1}\\
\end{align*}
and the determinant
\begin{align*}
...
%
 ...
 %
 & = |\bm{C}^{*^{ - 1}} + \bm{c} \bm{\Sigma}_{\tilde{\epsilon} + \epsilon}^{ - 1} \bm{c}^T| |\bm{C}^{*^{ - 1}}| |\bm{\Sigma}_{\tilde{\epsilon} + \epsilon}|
 \end{align*}
