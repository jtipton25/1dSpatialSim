...
\bm{\beta}_t & \sim N(\bm{\mu}_\beta, \bm{\Sigma}_\beta) & \bm{\Sigma}_\beta &  = \sigma^2_\beta \bm{I}_t\\
%
\tilde{\bm{\eta}}_t & \sim N(0, \bm{\Sigma}_{\tilde{\eta}}) & \bm{\Sigma}_{\tilde{\eta}} &  = \bm{c}^T {\bm{C}^*}^{ - 1} \bm{c}\\
%
\tilde{\bm{\epsilon}}_t & \sim N(0, \bm{\Sigma}_{\tilde{\epsilon}}) & \bm{\Sigma}_{\tilde{\epsilon}} &  = (\sigma^2_\epsilon + \sigma^2_\eta) \bm{I}_t - \bm{c}^T {\bm{C}^*}^{ - 1} \bm{c}\\
%
\end{align*}
%
\subsection{Parameter Model}
